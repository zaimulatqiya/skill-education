      ...
      <main className="flex min-h-screen flex-col items-center justify-center px-4 py-12 sm:px-6">
        ...
        <div className="w-full max-w-lg rounded-3xl border border-slate-800 bg-slate-900/50 backdrop-blur-xl shadow-2xl shadow-black/40">
          ...
          <div className="border-b border-slate-800/60 bg-white/5 px-6 py-8 text-center sm:px-8">
            ...
            <p className="mt-2 text-base text-slate-400">Selesaikan misi di bawah ini secara berurutan.</p>
          </div>
          ...
          <div className="flex flex-col gap-6 px-6 py-8 sm:px-8">
            ...
            <div className="group relative rounded-2xl border border-slate-800 bg-slate-900/40 p-5 transition-all hover:border-slate-700 hover:bg-slate-800/50">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  <div>
                    <h3 className="font-medium text-white">Tag 3 Teman</h3>
                    <p className="mt-1 text-sm leading-relaxed text-slate-400">Tag 3 temenmu di kolom komentar postingan Instagram Skill Education.</p>
                  </div>
                  <Link
                    href="#"
                    className="inline-flex items-center gap-2 rounded-lg bg-slate-800 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-600 hover:text-white border border-slate-700 hover:border-blue-500/50 active:scale-[0.98]"
                  >
            ...
            <div className="group relative rounded-2xl border border-slate-800 bg-slate-900/40 p-5 transition-all hover:border-slate-700 hover:bg-slate-800/50">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  <div>
                    <h3 className="font-medium text-white">Follow Instagram</h3>
                    <p className="mt-1 text-sm leading-relaxed text-slate-400">Wajib follow akun Instagram resmi Skill Education.</p>
                  </div>
                  <Link
                    href="#"
                    className="inline-flex items-center gap-2 rounded-lg bg-slate-800 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-pink-600 hover:text-white border border-slate-700 hover:border-pink-500/50 active:scale-[0.98]"
                  >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-relaxed text-slate-400">Langkah terakhir, bergabunglah ke dalam grup peserta.</p>
                  </div>
                  <Link
                    href="#"
