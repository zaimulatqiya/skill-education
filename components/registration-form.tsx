    ...
    <div className="w-full mx-auto text-left">
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="pt-4 md:col-span-2">
          <button
            type="submit"
            disabled={loading || !formData.fullName || !formData.age || !formData.programPackage || !formData.startPeriod || !formData.birthPlace || !formData.birthDate || !formData.whatsapp}
            className={`w-full font-bold py-4 rounded-xl shadow-lg transition-all duration-200 flex items-center justify-center ${
              loading || !formData.fullName || !formData.age || !formData.programPackage || !formData.startPeriod || !formData.birthPlace || !formData.birthDate || !formData.whatsapp
